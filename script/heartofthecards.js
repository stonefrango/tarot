...
function deal() {
    if (spreadCardCountRemain > 0) {
        ...
        if (selectedCards[ind].card.cardimg != null) {
            currentCardContentElement.querySelector(".cardfront").style.backgroundImage = "url('../images/" + selectedCards[ind].card.cardimg + "')";
        } else {
